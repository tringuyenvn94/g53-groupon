...
<section class='detailDeal'>
                    <div class='mod-infoDeal'>
                        ...
                        <li><asp:Image ID="Image_Top" runat="server"></asp:Image><%--<img src="../Images_Product/hinh san pham 3.png" alt='NHA KHOA DDS' title='NHA KHOA DDS' id='img1' />--%></li>
                        </ul>
                        ...
                        <div class='intro-pro'>
                            <div class='amo-detail'>
                                <div class='amo-rating'>
                                    ...
                                    <p><asp:Label ID="Label_MT" runat="server" Text=""></asp:Label></p></div></div>
                                    <div id='dCountBuy' class='count-buy'><div class='one-city'><p><span><asp:Label ID="Label_SNM" runat="server" Text=""></asp:Label></span> người đã mua</p></div></div>
                ...
                <span class="short-cm" style="width:175px"><%# Eval("ChiTiet") %></span></p>
                                ...
                                <div class='side-deal'>
                                    <ul id="ulListSideDeal" class="list-sidedeal">
                                        <li>
<asp:DataList ID="DataList_SP2" runat="server">
    <ItemTemplate>
                    ...
                    <div class="info-offer">
                        <div>
                            ...
                            <h1><%# Eval("TenSanPham") %></h1>
                                           ...
                                           <%-- <div class='gr-deal-o gr-side-deal'>
                                                <section class='deal deal-img coffee-offer'><a href='http://www.nhommua.com/tp-ho-chi-minh/san-pham/vi-du-lich-tien-loi-7F01050605027C.html' title='VÍ DU LỊCH TIỆN LỢI'><h1>
                                                    <img src='http://www.nhommua.net/Upload/14613/610x377/VI-DU-LICH-TIEN-LOI_2012912162825474.jpg' alt='VÍ DU LỊCH TIỆN LỢI'></h1></a><i class='shadow-side'></i><a class='deliver-icon'><p class='countBuy'>
                                                        <b>42</b> đã mua</p><p>Giao sản phẩm</p><span class='deli-freeship'></span></a><div class='offer-detail'><p class='meta-offer'><a>
                                                            <span><del>90.000</del><sup><u>đ</u></sup></span>
                                                            <span class='price-offer'>50.000<sup><u>đ</u></sup></span></a></p><div class='info-offer'><div><a href='http://www.nhommua.com/tp-ho-chi-minh/san-pham/vi-du-lich-tien-loi-7F01050605027C.html' title='VÍ DU LỊCH TIỆN LỢI'>
                                                                <h1>VÍ DU LỊCH TIỆN LỢI</h1></a></div></div></div>
